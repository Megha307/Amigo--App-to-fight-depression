...
public class CustomMessagesActivity extends MessagesActivity
  ...
  private String BASE_URL = "http://192.168.7.108:8008/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messagesAdapter.addToStart(MessagesFixtures.getFakeTextMessage("Hello! I'M Amor,a friendly bot.:) I'm here to help you find support on Amigo"),true);
    ...
    public void onMessageLongClick(Message message) {
        ...
        layout.findViewById(R.id.btnSet).setOnClickListener((v)-> {
            if(TextUtils.isEmpty(etIp.getText().toString()) && TextUtils.isEmpty(etIp.getText().toString())){
